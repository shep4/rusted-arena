...
function buildGunMesh(w) {
  ...
  if (v.knife) {
    ...
    return { g, muzzle: new THREE.Vector3(0, 0, -v.len), eject: null };
  }
  ...
  if (v.mag) box(dark, v.w * 0.7, v.mag, 0.055, 0, -v.h / 2 - v.mag / 2, -receiverLen * 0.6); // magazine
  ...
  if (v.bolt) cyl(steel, 0.012, 0.09, v.w / 2 + 0.03, v.h * 0.3, -receiverLen * 0.5, Math.PI / 2);
  ...
  return { g, muzzle: new THREE.Vector3(0, v.h * 0.25, -v.len + 0.05), eject: new THREE.Vector3(v.w / 2 + 0.01, 0.03, -receiverLen * 0.4) };
}
